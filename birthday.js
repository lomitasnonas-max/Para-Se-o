...
(function() {
  ...
  function buildBdayScreen() {
    ...
    screen.innerHTML = `
      ...
      <div class="bday-inner">
        ...
        <div class="bday-nombre">${(typeof FRIEND_NAME !== 'undefined' && FRIEND_NAME) ? FRIEND_NAME : ''} 🩷</div>
    ...
    // Botón entrar
    document.getElementById('bday-enter-btn').addEventListener('click', closeBdayScreen);
  }
  ...
  function playBdaySong() {
    ...
    aud.src = BDAY_SONG;
    aud.play().catch(() => {});
    if (typeof showToast === 'function') showToast(`🎂 ¡feliz cumpleaños ${(typeof FRIEND_NAME !== 'undefined' && FRIEND_NAME) ? FRIEND_NAME : ''}!`);
  }
    ...
    modal.innerHTML = `
      ...
      <div class="bday-modal-box">
        ...
        <div class="bday-modal-body">
          ...
          <div class="bday-modal-sig">— con cariño, ${(typeof SIGNATURE_NAME !== 'undefined' && SIGNATURE_NAME) ? SIGNATURE_NAME : ''} 🩷</div>
        </div>
  ...
  // ── Modal especial de canción sorpresa ──
    ...
    modal.innerHTML = `
      ...
      <div class="bday-paulo-box">
        ...
        <div class="bday-paulo-inner">
          <div class="bday-paulo-badge">${(typeof BDAY_PAULO_BADGE !== 'undefined' && BDAY_PAULO_BADGE) ? BDAY_PAULO_BADGE : '🎁 sorpresa'}</div>
          <div class="bday-paulo-title">${(typeof BDAY_PAULO_SONG_NAME !== 'undefined' && BDAY_PAULO_SONG_NAME) ? BDAY_PAULO_SONG_NAME : 'Canción sorpresa'}</div>
          ...
          <div class="bday-paulo-player">
            ...
            <div class="bday-paulo-player-info">
              <div class="bday-paulo-song">${(typeof BDAY_PAULO_SONG_NAME !== 'undefined' && BDAY_PAULO_SONG_NAME) ? BDAY_PAULO_SONG_NAME : 'Canción sorpresa'}</div>
...
})(); // Fin del IIFE — nada se filtra al scope global excepto lo asignado a window.*
